...
export class CreateProposalComponent {
    ...
    constructor(private fb: FormBuilder,
        ...
        this.createProposalForm = this.fb.group({
            ...
            nftid: this.fb.control([], Validators.required)
        });
    }

    async submitProposal() {
        const { title, description, nftid } = this.createProposalForm.getRawValue();
        await this.veim.submitProposal(title, description, nftid)
